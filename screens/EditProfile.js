    ...
    <ScrollView backgroundColor='white'>
      <Box flex={1} >
        ...
        <Box flex={1} padding={20}>
          ...
          >
            <InputField placeholder={userData.username} value={username} onChangeText={(text) => setusername(text)}  placeholderTextColor={"grey"}/>
          </Input>
          ...
          >
            <InputField placeholder={userData.number} value={number} keyboardType="numeric" onChangeText={(text) => setnumber(text)}  placeholderTextColor={"grey"}/>
          </Input>
